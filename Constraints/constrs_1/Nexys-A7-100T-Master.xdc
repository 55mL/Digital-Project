...
## Buttons
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { rstn_i }]; # CPU_RESETN (ปุ่ม Reset)
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { btnc_i }]; # BTNC (ปุ่มกดตรงกลางสำหรับสุ่มสี)

## RGB LED (LD17)
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { led17_r }]; # ขาสีแดง
set_property -dict { PACKAGE_PIN R11   IOSTANDARD LVCMOS33 } [get_ports { led17_g }]; # ขาสีเขียว
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { led17_b }]; # ขาสีน้ำเงิน

## -------------------------------------------------------------------------------------------------
## Other Unused Pins (Commented Out)
## -------------------------------------------------------------------------------------------------
